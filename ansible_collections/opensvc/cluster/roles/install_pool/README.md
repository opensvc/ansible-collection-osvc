...
`install_pool_osvc_pool_name`

The cluster pool name.

Default value is `pool`

`install_pool_osvc_pool_type`
...
`install_pool_osvc_pool_network`
    ...
    - hosts: all
      tasks:
        - import_role:
          ...
          vars:
            install_pool_osvc_pool_name: dirpool
            install_pool_osvc_pool_type: directory
            osvc_pool_path: /data
    ...
    - hosts: all
      tasks:
        - import_role:
            name: opensvc.cluster.install_pool
          vars:
            install_pool_osvc_pool_name: drbdpool
            install_pool_osvc_pool_type: drbd
            osvc_pool_vg: datavg
