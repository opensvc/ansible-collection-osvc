...
`install_cni_osvc_cni_plugins_dir`
...
`install_cni_osvc_cni_config_dir`
    ...
    - hosts: all
      tasks:
        - import_role:
          ...
          vars:
            install_cni_osvc_cni_plugins_dir: /usr/libexec/cni/bin
            install_cni_osvc_cni_config_dir: /var/lib/opensvc/cni/net.d
